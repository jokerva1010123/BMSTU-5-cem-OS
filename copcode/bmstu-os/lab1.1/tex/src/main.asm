...
020A:0746  E8 0070		;*		call	sub_1			;*(07B9)s
...
;; порт 3F2h - адрес порта цифрового управления
;; Отправляем команду 0Ch (00001100)
;; Отправление команды отключения моторчика OCh в порт дисковода 3F2h
020A:0788  B0 0C				mov	al,0Ch
020A:078A  BA 03F2				mov	dx,3F2h
020A:078D  EE					out	dx,al			; port 3F2h, dsk0 contrl output

;; Проверка - установлен ли флаг PF?
020A:078E			loc_3:
020A:078E  58					pop	ax
020A:078F  F7 06 0314 0004		test	word ptr ds:[314h],4	; (0040:0314=3200h)
020A:0795  75 0C				jnz	loc_4			; Jump if not zero
;; Косвенный вызов прерывания 1Ch (1Ch * 4 = 70h)
...
020A:07AA  E6 20				out	20h,al			; port 20h, 8259-1 int command									;  al = 20h, end of interrupt
